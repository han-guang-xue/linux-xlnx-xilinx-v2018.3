...
int pci_setup_device(struct pci_dev *dev)
{
	...
	case PCI_HEADER_TYPE_NORMAL:		    /* standard header */  //PCI_HEADER_TYPE_NORMAL 为 0
	...
	case PCI_HEADER_TYPE_CARDBUS:		    /* CardBus bridge header */  //PCI_HEADER_TYPE_CARDBUS 为 2
		if (class != PCI_CLASS_BRIDGE_CARDBUS)  //PCI_CLASS_BRIDGE_CARDBUS 为 0x0607
			goto bad;
		pci_read_irq(dev);
